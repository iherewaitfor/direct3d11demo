...
HRESULT InitWindow( HINSTANCE hInstance, int nCmdShow )
{
    ...
    g_hWnd = CreateWindow( L"TutorialWindowClass", L"Direct3D 11 UseShareTextureRGBA", WS_OVERLAPPEDWINDOW,
...
bool getSharedTextureHandle(HANDLE& sharedHandle) {
    HANDLE hMapping = OpenFileMapping(FILE_MAP_ALL_ACCESS, NULL, L"ShareMemory_SharedHandle_RGBA_WithoutLock");
