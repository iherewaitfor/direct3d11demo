...
std::wstring VIDEO_FILE_NAME = L"guilin_640x360_rgba.rgb";
...
ScalingVideo*     g_scalingVideo = NULL;
...
HRESULT InitWindow( HINSTANCE hInstance, int nCmdShow )
{
    ...
    g_hWnd = CreateWindow( L"TutorialWindowClass", L"Direct3D 11 ShareTextureRGBAFFmpeg CreateShareTexture", WS_OVERLAPPEDWINDOW,
